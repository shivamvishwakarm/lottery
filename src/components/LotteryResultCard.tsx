...
const LotteryResultCard: React.FC<LotteryResultCardProps> = ({ name, mobileno, ticket, date }) => {
  ...
  return (
    <div 
      className="flex flex-col justify-center items-center mb-8 text-xl h-full tracking-widest"
      style={{ 
    ...
    >
      <h1 className="text-5xl mt-8 font-bold text-blue-600">Kerala Lottery Results</h1>

      <div
        className="flex flex-col justify-center items-center bg-blue-700 my-6 rounded w-1/2 h-auto text-white" >
